...
var requestBody = _.template(fs.readFileSync('./lib/templates/body.tpl').toString());
var requestPayload = _.template(fs.readFileSync('./lib/templates/request.tpl').toString());
